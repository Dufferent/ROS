...
#include <ros/ros.h>
#include <ros_tutorials_action/TutorialsActAction.h> // Auto Create After Building
...
protected :
    ...
    ros :: NodeHandle nh_;
    // 声明动作服务器
    actionlib::SimpleActionServer<ros_tutorials_action::TutorialsActAction>as_;
    // 用作动作名称
    std::string action_name_;
    // 声明用于发布的反馈及结果
    ros_tutorials_action::TutorialsActFeedback feedback_;
    ros_tutorials_action::TutorialsActResult result_;
public :
    ...
    void executeCB ( const ros_tutorials_action::TutorialsActGoalConstPtr & goal )
    {
        ros::Rate r(1);				
        bool success = true ;			
        // 循环周期: 1 Hz
...
int main(int argc,char**argv)
{
    ...
    FibonacciAction f("ros_tutorials_action");
    ros::spin();
    return 0;
}